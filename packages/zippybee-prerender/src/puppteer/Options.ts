import { ConsoleMessage, Page, LaunchOptions, Viewport, WaitForOptions } from 'puppeteer';
...
export const schema: JSONSchemaType<
  Omit<PuppeteerRendererOptions, 'inject' | 'pageHandler' | 'pageSetup' | 'consoleHandler' | 'navigationOptions'>
> &
  Schema = {
  type: 'object',
